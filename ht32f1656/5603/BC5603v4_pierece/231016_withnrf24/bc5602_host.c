...
//bank 2
    ...
    spi_w(0x30, 0x08);              //RX3
		spi_w(0x31, 0x20);              //RX4
		spi_w(0x32, 0x08);              //RX5
		spi_w(0x33, 0x24);			       //TX1     [0]  PAD_EN: TX PA driver enable
            ...
            if( !(spi_read_fifostatus()&0x20) )  // not TX_FULL
            {
                ...
                if( !(spi_read_fifostatus()&0x20) ) { // not TX_FULL
                    ...
                    if     (spiTxQ.remote_pipe_no==0) {movedata_spiTxQ_to_ptx_txfifo(0x13);} // test 0x13: pipe 0 as broadcast no_ack=1
								...
								movedata_spiTxQ_to_ptx_txfifo(0x13);
								movedata_spiTxQ_to_ptx_txfifo(0x13);
									write_PE0_RESET_0;
	write_PE0_SET_1;
	write_PE0_RESET_0;
