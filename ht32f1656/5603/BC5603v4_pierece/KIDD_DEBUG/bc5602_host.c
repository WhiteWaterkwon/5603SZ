...
//bank 0		
  ...
  //spi_w(0x05, 0x__);              //IRQ2 (17_FIFO_STATUS) (RO read only)
    ...
    spi_w(0x06, 0x80|0x10|0x00);         //IO1     [5:3]GIO2S[2:0]=0h:-     , [2:0]GIO1S[2:0]=0h:-      , [7:6]PADDS[1:0] PAD drive strength:0:0.5mA,1:1mA,2:5mA,3:10mA
...
//bank 1
    ...
    spi_w(0x24, 0x00);              //FCF1
		...
		#elif DATARATE == 1000
		  spi_w(0x35, 0x02);   				  //AGC9 DBFS_OFFSET [2:0]		PDIFF_THDUPH [1:0]	AGC_TS_EN [1:0]	 		
		#elif DATARATE == 2000
			 spi_w(0x35, 0x03);   				  //AGC9 DBFS_OFFSET [2:0]		PDIFF_THDUPH [1:0]	AGC_TS_EN [1:0]	 
		#endif	
