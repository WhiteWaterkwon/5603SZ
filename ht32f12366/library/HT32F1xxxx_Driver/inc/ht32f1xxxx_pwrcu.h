...
typedef enum
{
  PWRCU_LDO_DEFAULT = 0,     /*!< The LDO default output voltage                                            */
  PWRCU_LDO_OFFSET_DEC5P,    /*!< The LDO default output voltage offset -5%                                 */
  PWRCU_LDO_OFFSET_ADD3P,    /*!< The LDO default output voltage offset +3%                                 */
  PWRCU_LDO_OFFSET_ADD7P,    /*!< The LDO default output voltage offset +7%                                 */
} PWRCU_LDOFTRM_Enum;
#endif
/**
