/*********************************************************************************************************//**
 * @file    USART/HyperTerminal_TxRx/ht32_board_config.h
 * @version $Rev:: 427          $
...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_USART_TX_GPIO_ID            (GPIO_PB)
  #define HTCFG_USART_RX_GPIO_ID            (GPIO_PB)
  #define HTCFG_USART_TX_PIN                (AFIO_PIN_2)
  #define HTCFG_USART_RX_PIN                (AFIO_PIN_3)
  #define HTCFG_USART                       (HT_UART0)
  #define HTCFG_USART_CLK(CK)               (CK.Bit.UART0)
  #define HTCFG_USART_IRQ                   (UART0_IRQn)
  #define HTCFG_USART_IRQ_FUN               UART0_IRQHandler
#endif
  ...
  #define HTCFG_USART_IRQ                   (USART0_IRQn)
  #define HTCFG_USART_IRQ_FUN               USART0_IRQHandler
#endif
