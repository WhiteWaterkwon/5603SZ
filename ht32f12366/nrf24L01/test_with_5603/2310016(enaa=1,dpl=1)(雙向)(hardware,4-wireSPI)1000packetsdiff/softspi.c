...
#define SPI_CSN_SET_1       GPIO_WriteOutBits(HT_GPIOD, GPIO_PIN_0, SET)
#define SPI_MISO_SET_1      GPIO_WriteOutBits(HT_GPIOD, GPIO_PIN_2, SET)
#define SPI_SCK_SET_1       GPIO_WriteOutBits(HT_GPIOD, GPIO_PIN_3, SET)
#define SPI_MOSI_SET_1      GPIO_WriteOutBits(HT_GPIOD, GPIO_PIN_4, SET)
#define SPI_CE_SET_1        GPIO_WriteOutBits(HT_GPIOD, GPIO_PIN_6, SET)

#define SPI_CSN_RESET_0     GPIO_WriteOutBits(HT_GPIOD, GPIO_PIN_0, RESET)
#define SPI_MISO_RESET_0    GPIO_WriteOutBits(HT_GPIOD, GPIO_PIN_2, RESET)
#define SPI_SCK_RESET_0     GPIO_WriteOutBits(HT_GPIOD, GPIO_PIN_3, RESET)
#define SPI_MOSI_RESET_0    GPIO_WriteOutBits(HT_GPIOD, GPIO_PIN_4, RESET)
#define SPI_CE_RESET_0      GPIO_WriteOutBits(HT_GPIOD, GPIO_PIN_6, RESET)

#define SPI_MISO_IS_SET    (GPIO_ReadInBit(HT_GPIOD, GPIO_PIN_2)==SET)
/*
#define SPI_CSN_SET_1       HT_GPIOD->SRR = GPIO_PIN_0
#define SPI_MISO_SET_1      HT_GPIOD->SRR = GPIO_PIN_2
#define SPI_SCK_SET_1       HT_GPIOD->SRR = GPIO_PIN_3
#define SPI_MOSI_SET_1      HT_GPIOD->SRR = GPIO_PIN_4
#define SPI_CE_SET_1        HT_GPIOD->SRR = GPIO_PIN_6

#define SPI_CSN_RESET_0     HT_GPIOD->RR = GPIO_PIN_0
#define SPI_MISO_RESET_0    HT_GPIOD->RR = GPIO_PIN_2
#define SPI_SCK_RESET_0     HT_GPIOD->RR = GPIO_PIN_3
#define SPI_MOSI_RESET_0    HT_GPIOD->RR = GPIO_PIN_4
#define SPI_CE_RESET_0      HT_GPIOD->RR = GPIO_PIN_6
...
{
    AFIO_GPxConfig(GPIO_PD, AFIO_PIN_2, AFIO_MODE_1);
...
//  if (_current_pipe != pipe_no)
  ...
  spi_Write(W_TX_PAYLOAD_NOACK, e_begin); // Write cmd to write payload
    ...
    //set a high pulse on the CE for more than 10us
//  spi_SetCEState(TRUE);
//  delay_15us();                  //more than 10us
...
{
   	  u8 mask = _BV(RF_DR_LOW) | _BV(RF_DR_HIGH)| _BV(2)| _BV(1);
  //  u8 mask = _BV(RF_DR_LOW) | _BV(RF_DR_HIGH);
